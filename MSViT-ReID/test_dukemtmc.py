...
if __name__ == '__main__':
    ...
    net = DBN(num_classes=702, num_parts=[1,opt.num_part], net=opt.net, h=opt.img_height//16, w=opt.img_width//16, sparse_ratio=opt.sparse_ratio, split_size=opt.split_size, stride=opt.stride)
